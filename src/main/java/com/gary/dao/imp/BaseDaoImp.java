...
public  class BaseDaoImp<T> extends HibernateDaoSupport implements BaseDao<T> {
    ...
    public List<T> find(String queryName) {
        // TODO Auto-generated method stub
        List<T> list = (List<T>) getHibernateTemplate().find(queryName);
        return list;
    }
//
//    @Transactional(readOnly=true)
//    @SuppressWarnings("unchecked")
//    public List<T> find(String queryName, int values) {
//        // TODO Auto-generated method stub
...
//
//        List<T> list = (List<T>) getHibernateTemplate().execute(new HibernateCallback<T>() {
//
//            @SuppressWarnings("unchecked")
//            public List<T> doInHibernate(Session session) throws HibernateException {
//                // TODO Auto-generated method stub
